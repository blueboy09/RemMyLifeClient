 ...
 */
            ...
            /**
            *  GetDiaryListResponse bean class
            */
                  ...
                  if (serializeType){
                   ...
                   if ((namespacePrefix != null) && (namespacePrefix.trim().length() > 0)){
                       writeAttribute("xsi","http://www.w3.org/2001/XMLSchema-instance","type",
                           namespacePrefix+":getDiaryListResponse",
                           xmlWriter);
                   } else {
                       writeAttribute("xsi","http://www.w3.org/2001/XMLSchema-instance","type",
                           "getDiaryListResponse",
    ...
    public static class Factory{
        ...
        */
        public static GetDiaryListResponse parse(javax.xml.stream.XMLStreamReader reader) throws java.lang.Exception{
            GetDiaryListResponse object =
                new GetDiaryListResponse();
                ...
                if (reader.getAttributeValue("http://www.w3.org/2001/XMLSchema-instance","type")!=null){
                  ...
                  if (fullTypeName!=null){
                    ...
                    java.lang.String type = fullTypeName.substring(fullTypeName.indexOf(":")+1);
                            ...
                            if (!"getDiaryListResponse".equals(type)){
                                //find namespace for the prefix
                                java.lang.String nsUri = reader.getNamespaceContext().getNamespaceURI(nsPrefix);
                                return (GetDiaryListResponse)com.remmylife.diary.xsd.ExtensionMapper.getTypeObject(
                                     nsUri,type,reader);
                              }
