 ...
 */
            ...
            /**
            *  SearchByContentResponse bean class
            */
            @SuppressWarnings({"unchecked","unused"})
        
        public  class SearchByContentResponse
                  ...
                  if (serializeType){
                   ...
                   if ((namespacePrefix != null) && (namespacePrefix.trim().length() > 0)){
                       writeAttribute("xsi","http://www.w3.org/2001/XMLSchema-instance","type",
                           namespacePrefix+":searchByContentResponse",
                           xmlWriter);
                   } else {
                       writeAttribute("xsi","http://www.w3.org/2001/XMLSchema-instance","type",
                           "searchByContentResponse",
    ...
    public static class Factory{
        ...
        */
        public static SearchByContentResponse parse(javax.xml.stream.XMLStreamReader reader) throws java.lang.Exception{
            SearchByContentResponse object =
                new SearchByContentResponse();
                ...
                if (reader.getAttributeValue("http://www.w3.org/2001/XMLSchema-instance","type")!=null){
                  ...
                  if (fullTypeName!=null){
                    ...
                    java.lang.String type = fullTypeName.substring(fullTypeName.indexOf(":")+1);
                            ...
                            if (!"searchByContentResponse".equals(type)){
                                //find namespace for the prefix
                                java.lang.String nsUri = reader.getNamespaceContext().getNamespaceURI(nsPrefix);
                                return (SearchByContentResponse)com.remmylife.diary.xsd.ExtensionMapper.getTypeObject(
                                     nsUri,type,reader);
                              }
