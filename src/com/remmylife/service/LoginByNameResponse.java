 ...
 */
            ...
            /**
            *  LoginByNameResponse bean class
            */
            @SuppressWarnings({"unchecked","unused"})
        
        public  class LoginByNameResponse
                  ...
                  if (serializeType){
                   ...
                   if ((namespacePrefix != null) && (namespacePrefix.trim().length() > 0)){
                       writeAttribute("xsi","http://www.w3.org/2001/XMLSchema-instance","type",
                           namespacePrefix+":loginByNameResponse",
                           xmlWriter);
                   } else {
                       writeAttribute("xsi","http://www.w3.org/2001/XMLSchema-instance","type",
                           "loginByNameResponse",
    ...
    public static class Factory{
        ...
        */
        public static LoginByNameResponse parse(javax.xml.stream.XMLStreamReader reader) throws java.lang.Exception{
            LoginByNameResponse object =
                new LoginByNameResponse();
                ...
                if (reader.getAttributeValue("http://www.w3.org/2001/XMLSchema-instance","type")!=null){
                  ...
                  if (fullTypeName!=null){
                    ...
                    java.lang.String type = fullTypeName.substring(fullTypeName.indexOf(":")+1);
                            ...
                            if (!"loginByNameResponse".equals(type)){
                                //find namespace for the prefix
                                java.lang.String nsUri = reader.getNamespaceContext().getNamespaceURI(nsPrefix);
                                return (LoginByNameResponse)com.remmylife.diary.xsd.ExtensionMapper.getTypeObject(
                                     nsUri,type,reader);
                              }
