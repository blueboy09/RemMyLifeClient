 ...
 */
            ...
            /**
            *  UnshareDiary bean class
            */
            @SuppressWarnings({"unchecked","unused"})
        
        public  class UnshareDiary
    ...
    public static class Factory{
        ...
        */
        public static UnshareDiary parse(javax.xml.stream.XMLStreamReader reader) throws java.lang.Exception{
            UnshareDiary object =
                new UnshareDiary();
                ...
                if (reader.getAttributeValue("http://www.w3.org/2001/XMLSchema-instance","type")!=null){
                  ...
                  if (fullTypeName!=null){
                    ...
                    java.lang.String type = fullTypeName.substring(fullTypeName.indexOf(":")+1);
                            ...
                            if (!"unshareDiary".equals(type)){
                                //find namespace for the prefix
                                java.lang.String nsUri = reader.getNamespaceContext().getNamespaceURI(nsPrefix);
                                return (UnshareDiary)com.remmylife.service.ExtensionMapper.getTypeObject(
                                     nsUri,type,reader);
                              }
